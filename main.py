...
# SELECT * FROM ALON_test_male ORDER BY registered.date DESC LIMIT 20
# UNION
# SELECT * FROM ALON_test_female ORDER BY registered.date DESC LIMIT 20;
# s.query('ALON_test_male').order_by('ALON_test_male.registered.date.desc()).limit(20)
